...
class YoutubeIE(YoutubeBaseInfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        if is_upcoming is None and (live_content or is_live):
            is_upcoming = False
        live_start_time = None # parse_iso8601(get_first(live_broadcast_details, 'startTimestamp'))
        live_end_time = None # parse_iso8601(get_first(live_broadcast_details, 'endTimestamp'))
